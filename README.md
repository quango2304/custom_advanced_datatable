...
Node: this is just a fork of https://pub.dev/packages/advanced_datatable library that allow to implement **getRow** function inside the widget to separate the UI and logic 
